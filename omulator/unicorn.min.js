...
var MUnicornReady = (main) => {
  ...
  // it's already loaded from previous run
  else if (typeof MUnicorn === 'object') {
    main()
  }
  else {
    console.error("Something unexpected happened in MUnicornReady")
  }
}
...
var uc = {
    ...
    Unicorn: function (arch, mode) {
            ...
            switch (type) {
                ...
                default:
                    ...
                    if ((type & uc.HOOK_MEM_READ_UNMAPPED) ||
                        ...
                        var callback = (function (handle, user_data) {
                            return function (_, type, addr, size, value, _) {
                                return user_callback(handle, type, addr, size, value, user_data);
                            }
                        })(this, user_data);
        ...
        this.reg_write_type = function (regid, type, value) {
            ...
            if (typeof value === "bigint") {  // BigInt case
              value = value.toString(16)      // ElfUInt expects hex format
            }
        ...
        this.reg_write_u64    = function (regid, value) { this.reg_write_type(regid, 'i64', value); }
        ...
        this.reg_read_type = function (regid, type) {
            ...
            // Convert integer types
            if (type.includes('i') && !type.includes('64')) {
        ...
        this.reg_read_u64     = function (regid) { let val = this.reg_read_type(regid, 'i64'); return BigInt(val[0]>>>0)+(BigInt(val[1]>>>0)<<32n); }
